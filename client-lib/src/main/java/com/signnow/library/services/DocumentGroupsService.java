...
public class DocumentGroupsService extends ApiService implements DocumentGroups {
  ...
  @Override
  public DocumentGroup.DocumentGroupsListResponse getUserDocumentGroups(
      Integer limit, Integer offset) throws SNException {
    Map<String, String> params = new HashMap<>();
    if (limit != null) {
      if (limit <= 0) {
        throw new SNApiException(
            "The limit query parameter is required and must be between 1 and 50");
      } else {
    ...
    return client.get(
        "/user/documentgroups", params, DocumentGroup.DocumentGroupsListResponse.class);
  }
  ...
  @Override
  public void resendInvites(String documentGroupId, String inviteId, String email)
      throws SNException {
    Map<String, String> params = new HashMap<>();
