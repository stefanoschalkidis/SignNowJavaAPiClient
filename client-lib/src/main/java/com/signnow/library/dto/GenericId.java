...
public class GenericId {
  ...
  @JsonIgnore private final Map<String, String> additionalMembers = new HashMap<>();
  ...
  /**
   * For debug purposes, contains API response object additional information that is not supported
   * via DTO.
   *
   * @return
   */
